...
extern "C"
{
  ...
  extern void reorder(apf::Mesh2* m, int ndof, const int nnodes, const int comp, apf::Numbering* dof_statusNumbering, apf::Numbering* nodeNums, apf::Numbering* elNums);
}
