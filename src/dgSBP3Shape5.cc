...
// unknown element???
class DG5SBP3Linear : public FieldShape
{
  public:

    DG5SBP3Linear() { registerSelf(apf::DG5SBP3Linear::getName()); }
//    SBPLinear() { registerSelf(apf::Linear::getName()); }  // use inherited/default constructor?
    const char* getName() const { return "DG5SBP3Linear"; }
...
class DG5SBP3Quadratic : public FieldShape
{
  public:
    DG5SBP3Quadratic() { registerSelf(apf::DG5SBP3Quadratic::getName()); }
//    SBPLinear() { registerSelf(apf::Linear::getName()); }  // use inherited/default constructor?
    const char* getName() const { return "DG5SBP3Quadratic"; }
...
class DG5SBP3Cubic : public FieldShape
{
  public:
    DG5SBP3Cubic() { registerSelf(apf::DG5SBP3Cubic::getName()); }
//    SBPLinear() { registerSelf(apf::Linear::getName()); }  // use inherited/default constructor?
    const char* getName() const { return "DG5SBP3Cubic"; }
...
class DG5SBP3Quartic : public FieldShape
{
  public:
    DG5SBP3Quartic() { registerSelf(apf::DG5SBP3Quartic::getName()); }
//    SBPLinear() { registerSelf(apf::Linear::getName()); }  // use inherited/default constructor?
    const char* getName() const { return "DG5SBP3Quartic"; }
...
{
  static DG5SBP3Linear linear1;
  static DG5SBP3Quadratic quadratic1;
  static DG5SBP3Cubic cubic1;
  static DG5SBP3Quartic quartic1;
  switch (order) {
    case 1:
	  return &linear1;
	case 2:
