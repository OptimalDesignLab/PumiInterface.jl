...
#    interp_op = [0.5 0 0; 0 0.5 0; 0 0 0.5]
  ...
  function test_interp_rev(mesh)
    ...
    dxidx_in = zeros(2, 2, mesh.numNodesPerElement)
    ...
    dxidx_out = zeros(2, 2, mesh.numNodesPerFace)
    ...
    jac_size = 2*2*mesh.numNodesPerFace
    ...
    dxidx_out2 = zeros(Complex128, 2, 2, mesh.numNodesPerFace)
